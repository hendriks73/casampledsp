...
public class CAAudioFileFormat extends AudioFileFormat {
  ...
  public CAAudioFileFormat(
    ...
    super(
        getAudioFileFormatType(url, dataFormat),
        getLength(url),
        new CAAudioFormat(
            dataFormat,
            sampleRate,
            ...
            determineFrameRate(dataFormat, sampleRate, frameRate),
            bigEndian,
            bitRate,
            vbr),
  ...
  private static float determineFrameRate(
      final int dataFormat, final float sampleRate, final float frameRate) {
  ...
  private static Type getAudioFileFormatType(final String url, final int dataformat)
      throws UnsupportedAudioFileException {
    if (url == null) {
