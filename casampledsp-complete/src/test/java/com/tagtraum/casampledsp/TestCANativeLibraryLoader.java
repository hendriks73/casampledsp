...
public class TestCANativeLibraryLoader {
  ...
  public void testFindNonExistingFile() throws FileNotFoundException {
    CANativeLibraryLoader.findFile(
        "testFindFile",
        CANativeLibraryLoader.class,
        new FileFilter() {
          @Override
  ...
  public void testLibFileFilter() throws IOException {
    final CANativeLibraryLoader.LibFileFilter mylib =
        new CANativeLibraryLoader.LibFileFilter("mylib");
